...
g1 = Game.create(name: 'GTA5', user_id: u1.id)
g2 = Game.create(name: 'Bugdom', user_id: u2.id)
g3 = Game.create(name: 'Portal', user_id: u3.id)
g4 = Game.create(name: 'Half Life', user_id: u1.id)
